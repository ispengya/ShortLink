...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
     ...
     */
    List<HashMap<String, Object>> listTopIpByShortLink(@Param("param") ShortLinkStatsParam requestParam);
    ...
    @Select("SELECT " +
            ...
            "    count DESC " +
            "LIMIT 5;")
    List<HashMap<String, Object>> listTopIpByGroup(@Param("param") ShortLinkGroupStatsParam requestParam);

    /**
     * 根据短链接获取指定日期内新旧访客数据
     */
    HashMap<String, Object> findUvTypeCntByShortLink(@Param("param") ShortLinkStatsParam requestParam);
     ...
     */
    LinkAccessStatsDO findPvUvUidStatsByShortLink(@Param("param") ShortLinkStatsParam requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid;")
    LinkAccessStatsDO findPvUvUidStatsByGroup(@Param("param") ShortLinkGroupStatsParam requestParam);
    ...
    IPage<LinkAccessLogsDO> selectGroupPage(@Param("param") ShortLinkGroupStatsAccessRecordParam requestParam);
}
