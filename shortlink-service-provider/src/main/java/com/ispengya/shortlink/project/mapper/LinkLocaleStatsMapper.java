...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
    ...
    List<LinkLocaleStatsDO> listLocaleByShortLink(@Param("param") ShortLinkStatsParam requestParam);
    ...
    List<LinkLocaleStatsDO> listLocaleByGroup(@Param("param") ShortLinkGroupStatsParam requestParam);
}
